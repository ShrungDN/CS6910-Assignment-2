...
def parse_arguments():
    ...
    parser.add_argument('-a', '--activation', type=str, default='GELU', help='Activation function to be used: "ReLU", "GELU", "SiLU" or "Mish"')
    ...
    parser.add_argument('-sf1', '--size_filters1', type=int, default=3, help='Size of filters in 1st convolution layer')
    parser.add_argument('-sf2', '--size_filters2', type=int, default=3, help='Size of filters in 2nd convolution layer')
    parser.add_argument('-sf3', '--size_filters3', type=int, default=3, help='Size of filters in 3rd convolution layer')
    parser.add_argument('-sf4', '--size_filters4', type=int, default=9, help='Size of filters in 4th convolution layer')
    parser.add_argument('-sf5', '--size_filters5', type=int, default=9, help='Size of filters in 5th convolution layer')
